    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <Card className="p-6 space-y-4">
        ...
        <div className="space-y-2">
          <Label htmlFor="title">
            {t('routeTitle')} <span className="text-destructive">{t('required')}</span>
          </Label>
          <Input
            id="title"
            required
      ...
      <Card className="p-6 space-y-4">
        ...
        <div className="space-y-2">
          <Label htmlFor="category">
            {t('category')} <span className="text-destructive">{t('required')}</span>
          </Label>
          <select
            id="category"
            required
            ...
            onChange={(e) => setFormData({ ...formData, category: e.target.value as RouteInsert['category'] })}
          >
        ...
        <div className="space-y-2">
          <Label htmlFor="difficulty">
            {t('difficultyLabel')} <span className="text-destructive">{t('required')}</span>
          </Label>
          <select
            id="difficulty"
            required
            ...
            onChange={(e) => setFormData({ ...formData, difficulty: e.target.value as RouteInsert['difficulty'] })}
          >
            <option value="easy">{t('difficultyEasyLabel')}</option>
            <option value="moderate">{t('difficultyModerateLabel')}</option>
            <option value="challenging">{t('difficultyChallengingLabel')}</option>
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <Label htmlFor="distance">
              {t('distanceLabel')} <span className="text-destructive">{t('required')}</span>
            </Label>
            <span className="text-sm font-medium">{formData.distance_km} {t('distanceUnit')}</span>
          </div>
          <Slider
            id="distance"
            min={10}
            ...
            onValueChange={([value]) => setFormData({ ...formData, distance_km: value })}
          />
        </div>
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <Label htmlFor="duration">
              {t('durationLabel')} <span className="text-destructive">{t('required')}</span>
            </Label>
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            ...
            <span className="text-sm font-medium">{formData.elevation_gain_m} {t('elevationUnit')}</span>
          </div>
          <Slider
            id="elevation"
            min={0}
            ...
            onValueChange={([value]) => setFormData({ ...formData, elevation_gain_m: value })}
          />
        </div>
      </Card>
